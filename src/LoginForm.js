    ...
    return (
      <Form style={formStyle}>
        <Form.Group controlId="joinForm">
          ...
          <Button style={buttonStyle} onClick={this.join} variant="primary" type="button" className="d-block w-100">회원가입</Button>
        </Form.Group>
        ...
        <Form.Group controlId="loginForm">
          ...
          <Button style={buttonStyle} onClick={this.login} variant="primary" type="button" className="d-block w-100">로그인</Button>
        </Form.Group>
      </Form>
    );
  }
